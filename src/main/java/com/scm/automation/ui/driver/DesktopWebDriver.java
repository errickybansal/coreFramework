...
/**
 * DesktopWebDriver class.
 *
 * @author vipin.v
 * @version 1.0.75
 * @since 1.0.75
 */
public class DesktopWebDriver extends AbstractDriver {

  /**
   * Constructor for DesktopWebDriver.
   *
   ...
   * @since 1.0.75
   */
  public DesktopWebDriver(URL serverUrl, DesiredCapabilities capabilities, Settings settings) {
